...
export default function Layout({ children, currentPageName }) {
  ...
  return (
    <div className="min-h-screen font-inter flex" style={{ position: "relative", "--sidebar-width": sidebarOpen ? "16rem" : "5rem" }}>
      ...
      {/* Desktop Sidebar */}
      <aside className={`hidden md:flex flex-col fixed inset-y-0 left-0 z-40 glass-panel border-r border-slate-200/70 transition-all duration-300 ${sidebarOpen ? "w-64" : "w-20"}`}>
