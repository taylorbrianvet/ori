    ...
    <PageContainer>
      ...
      <div className="relative mb-4">
        ...
        <input
          ...
          placeholder="Search name, email, phone, service…" className="bg-gray-950 text-[#fafafa] pr-4 pl-10 py-2.5 text-sm opacity-25 rounded-xl w-full border border-white/12 placeholder-white/30 focus:outline-none focus:border-white/25 focus:bg-white/10 transition-all" />
