    ...
    <PageContainer>
      ...
      <div className="mt-3 glass-card p-4">
        ...
        <div className="flex gap-2 mb-4">
          <textarea
            className="flex-1 px-3 py-2.5 rounded-xl border border-white/25 bg-black/30 text-sm text-white placeholder:text-white/50 focus:outline-none focus:border-white/50 resize-none"
            rows={2}
