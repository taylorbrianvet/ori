    ...
    <PageContainer>
      <div className="flex items-start justify-between mb-6 lg:mb-8">
        <div className="flex items-center gap-3">
          <img src="https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/69ae5c53616161c3fff1c63f/785994162_PNGTAMULogowhite.png" alt="Texas A&M Logo" className="w-12 h-12 rounded-xl object-cover shrink-0" />
          <div>
