    ...
    <PageContainer>
      ...
      <div className="flex items-start justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-semibold text-white">Surgical Log</h1>
            <p className="text-xs text-white/45 mt-0.5">{entries.length} procedures recorded</p>
          </div>
        </div>
        <button
            ...
            <table className="w-full text-xs">
              <thead>
                <tr className="border-b border-white/10">
                  {["Case #", "Date", "Service", "Species", "Laterality", "Procedure", "Primary Surgeon", "Residents", "Faculty", "Emergency", "Logged"].map((h) => (
              ...
              <tbody>
                {filtered.map((entry, i) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3 text-white/60 whitespace-nowrap">{entry.faculty_present || "—"}</td>
                    <td className="px-4 py-3">
                      {entry.emergency ? (
